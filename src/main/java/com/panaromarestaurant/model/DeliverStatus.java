...
// JPA and persistence annotations
...
@Table(name = "deliverystatus") // Maps this entity to the "deliverystatus" table in the database
...
public class DeliverStatus {
    ...
    private Integer id; // Represents the unique identifier (primary key) for each DeliverStatus record
    ...
    private String name; // Represents the name of the delivery status (e.g., "Pending", "Delivered", "Cancelled")
}

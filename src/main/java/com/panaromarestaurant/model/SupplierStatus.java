...
@Table(name = "supplier_status") // Maps this entity to the "status" table in the database
...
public class SupplierStatus {
    ...
    private Integer id; // Represents the primary key for the status table

    // @Column(name = "status_name", nullable = false, length = 100)
    // This annotation is commented out, but could be used for explicit column
    // mapping

    private String name; // Represents the status name in the table (e.g., Active, Inactive)
}

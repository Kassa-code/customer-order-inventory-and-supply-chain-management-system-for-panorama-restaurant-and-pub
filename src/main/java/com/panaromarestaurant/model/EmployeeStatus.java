...
@Table(name = "status") // Maps this entity to the "employee_status" table in the database
...
public class EmployeeStatus {
    ...
    private Integer id; // Represents the primary key for the employee_status table

...
@Table(name = "module") // Maps this entity to the "module" table in the database
...
public class Module {
    ...
    private Integer id; // Represents the primary key for the module table

    // Column mapping (Optional, only needed if the column name differs from the field name)
    private String name; // Represents the module name in the table
}

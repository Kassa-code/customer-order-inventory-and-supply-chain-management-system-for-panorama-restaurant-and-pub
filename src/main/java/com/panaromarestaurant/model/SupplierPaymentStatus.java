...
@Table(name = "supplierpaymentstatus") // Specifies the exact table name in the database
...
public class SupplierPaymentStatus {
    ...
    private Integer id; // Unique identifier for each supplier payment status record

    private String name; // The name of the supplier payment status (e.g., "Paid", "Pending", "Partially Paid")

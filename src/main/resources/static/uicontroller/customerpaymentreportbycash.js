...
const generateReport = () => {
  ...
  let dataList = getServiceRequest("/reportcustomerpaymentbycash/bysdedtype?startdate=" + dteStartDate.value + "&enddate=" + dteEndDate.value + "&type=" + selectType.value);
  ...
  fillDataIntoReportTable(tableBodyCustomerPaymentByCashReport, reportDataList, propertyList);

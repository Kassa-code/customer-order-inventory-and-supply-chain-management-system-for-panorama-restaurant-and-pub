...
const refreshOrderTable = () => {
  ...
  let orders = getServiceRequest("/delivery/orderlist");
  ...
  let propertyList = [
    ...
    { propertyName: generateOrderAddress, dataType: "function" },
    ...
    { propertyName: "delivery_charge", dataType: "decimal" },
...
const generateOrderAddress = (dataOb) => {
  // Access and return the order type name using the order_type_id reference
  return dataOb.delivery_address;
}

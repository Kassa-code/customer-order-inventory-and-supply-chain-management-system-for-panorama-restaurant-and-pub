...
const generateReport = () => {
  ...
  let dataList = getServiceRequest("/reportdailysales/bysdedtype?startdate=" + dteStartDate.value + "&enddate=" + dteEndDate.value + "&type=" + selectType.value);
  ...
  fillDataIntoReportTable(tableBodyDailySalesReport, reportDataList, propertyList);

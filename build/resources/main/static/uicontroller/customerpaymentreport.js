...
const generateReport = () => {
  ...
  let dataList = getServiceRequest("/reportcustomerpayment/bysdedtype?startdate=" + dteStartDate.value + "&enddate=" + dteEndDate.value + "&type=" + selectType.value);
  ...
  fillDataIntoReportTable(tableBodyCustomerPaymentReport, reportDataList, propertyList);
...
const printChart = () => {
  ...
  const printView = `
   <html>
     <head>
       <title>Print Customer Payment Report</title>

...
const generateReport = () => {
  ...
  let dataList = getServiceRequest("/reportsupplierpayment/bysdedtype?startdate=" + dteStartDate.value + "&enddate=" + dteEndDate.value + "&type=" + selectType.value);
  ...
  fillDataIntoReportTable(tableBodyPurchasePaymentReport, reportDataList, propertyList);
...
const printChart = () => {
  ...
  const printView = `
   <html>
     <head>
       <title>Print Supplier Payment Report</title>
